  ...
  private async seedPerfumes() {
    ...
    const perfumes = [
      ...
      },
      {
        ...
        model: 'AT2024',
        assetUrl:
          'https://cdn.beymen.com/mnresize/596/830/productimages/0qgphlts.5ls_IMG_01_3700578504364.jpg',
        serialNumber: 444567,
        notes: ['sweet', 'amber', 'vanilla'],
        type: 'edp',
        season: 'fall',
        sillage: 'strong',
        longevity: 'very long',
        gender: 'man',
        description: 'A captivating blend of creamy vanilla, warm amber, and soft musk, creating an addictive fragrance that exudes elegance and cozy sophistication.',
        warrantyStatus: 4,
      ...
      },
      {
        ...
        model: 'PG2024',
        assetUrl:
          'https://cdn.beymen.com/mnresize/596/830/productimages/0709001254_IMG_01_3700578506009.jpg',
        serialNumber: 494567,
        notes: ['almond', 'vanilla', 'powdery'],
        type: 'edp',
        season: 'winter',
        sillage: 'strong',
        longevity: 'long',
        gender: 'unisex',
        description: 'A refined fragrance combining creamy almond, fresh lavender, and warm vanilla, delivering a bold yet elegant scent with timeless appeal.',
        warrantyStatus: 4,
        distributor: distributors[1]._id,
        categories: [
          categories.find((c) => c.name === 'Women')._id,
