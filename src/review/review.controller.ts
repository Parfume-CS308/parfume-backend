...
export class ReviewController {
  ...
  async getAllReviews(@Res() res: Response, @Param() paramInput: PerfumeIdDto): Promise<Response<AllReviewsResponse>> {
    try {
      Logger.log(`Fetching all reviews for perfume: ${paramInput.perfumeId}`, 'ReviewController.getAllReviews')
      const reviews = await this.reviewService.getAllReviews(paramInput.perfumeId)
      Logger.log(
